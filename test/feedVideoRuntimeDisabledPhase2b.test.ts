...
// app/lib/audienceFeedState.ts), so the scroll-deferral guard is keyed per
// audience; see app/test/feedScrollSmoothnessPhase1.test.ts for the full
// coverage of the new shouldDeferAudienceFeedCommit wiring.
