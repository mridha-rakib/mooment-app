    ...
    <View>
      ...
      <View style={styles.subTabBg}>
        <TouchableOpacity
          ...
          style={[
            styles.subTabItem,
            vibeSubTab === "Live" && styles.subTabItemActive,
          ]}
        >
          <Text
            style={[
              styles.subTabText,
              vibeSubTab === "Live" && styles.subTabTextActive,
            ]}
          >
            Live
          </Text>
        ...
        <TouchableOpacity
          ...
          style={[
            styles.subTabItem,
            vibeSubTab === "Mooments" && styles.subTabItemActive,
          ]}
        >
          <Text
            style={[
              styles.subTabText,
              vibeSubTab === "Mooments" && styles.subTabTextActive,
            ]}
          >
            Mooments
          </Text>
