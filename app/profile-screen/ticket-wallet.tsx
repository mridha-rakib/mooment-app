            ...
            {section.items.map((item) => (
              <View key={item.id} style={styles.cardContainer}>
                ...
                <View style={styles.sharedInfo}>
                  <Image source={{ uri: item.sharedBy.avatar }} style={[styles.avatar, { backgroundColor: colors.border }]} />
                ...
                <TouchableOpacity style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]} activeOpacity={0.9}>
                  ...
                  <View style={styles.cardBody}>
                    <Image source={{ uri: item.image }} style={[styles.ticketImage, { backgroundColor: colors.border }]} />
