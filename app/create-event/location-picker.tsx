            ...
            >
              {results.map((location) => (
                ...
                >
                  ...
                  <Text style={[styles.resultAddress, { color: colors.textSecondary }]} numberOfLines={3}>
                    {location.address}
                  </Text>
                </TouchableOpacity>
              ))}
...
const styles = StyleSheet.create({
  ...
  resultItem: {
    ...
    // minHeight (not a fixed height) keeps short results compact while
    // letting a wrapped title/address grow the row naturally — nothing here
    // clips content, so overflow is intentionally left unset.
    minHeight: 56,
    paddingHorizontal: 16,
    paddingVertical: 12,
  },
