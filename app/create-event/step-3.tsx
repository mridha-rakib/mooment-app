      ...
      .then(async (location) => {
        ...
        setStepThree({
          location: {
            ...draftLocation,
            address: nextAddress,
            formattedAddress: reverseLocation?.formattedAddress ?? reverseLocation?.address ?? nextAddress,
            addressLine1: reverseLocation?.addressLine1 ?? null,
            neighborhood: reverseLocation?.neighborhood ?? null,
            district: reverseLocation?.district ?? null,
            city: reverseLocation?.city ?? null,
            region: reverseLocation?.region ?? null,
            regionCode: reverseLocation?.regionCode ?? null,
            postalCode: reverseLocation?.postalCode ?? null,
            country: reverseLocation?.country ?? null,
            countryCode: reverseLocation?.countryCode ?? null,
            latitude: location.latitude,
            longitude: location.longitude,
            mapboxPlaceId: reverseLocation?.mapboxPlaceId ?? reverseLocation?.providerId ?? null,
            locationProvider: reverseLocation?.providerId ? 'mapbox' : null,
            providerResultType: reverseLocation?.providerResultType ?? null,
            searchLabel: label,
