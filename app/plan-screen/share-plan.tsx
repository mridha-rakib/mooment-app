...
const USERS = [
  ...
  { id: '2', name: 'Dj Koko', handle: '@selfd_d', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=150', status: 'Shared' },
  { id: '3', name: 'Dj Koko', handle: '@selfd_d', image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=150', status: 'Share' },
  { id: '4', name: 'Dj Koko', handle: '@selfd_d', image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=150', status: 'Share' },
];
...
export default function SharePlanScreen() {
  ...
  const handleShare = (id: string) => {
    setUsers(users.map(u => u.id === id ? { ...u, status: u.status === 'Share' ? 'Shared' : 'Share' } : u));
  };
