...
const USERS = [
  ...
  { id: '5', name: 'Dj Koko', handle: '@adhd_d', image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=150', status: 'Add' },
];
            ...
            >
              {user.status === 'Added' ? (
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                  <HugeiconsIcon icon={CheckmarkCircle02Icon} size={12} color="#8E8E9B" />
                  <Text style={[s.actionBtnText, s.actionBtnTextDark]}>Added</Text>
                </View>
              ) : (
                <Text style={[s.actionBtnText, s.actionBtnTextLight]}>Add</Text>
              )}
            </TouchableOpacity>
          </View>
        ))}
...
const s = StyleSheet.create({
  ...
  cancelText: { color: '#8E8E9B', fontSize: 14, fontWeight: '500' },
