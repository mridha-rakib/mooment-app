  ...
  const renderCartItem = (item: CartItem) => {
    ...
    return (
      <View key={item.id} style={styles.cartItem}>
        <Image source={{ uri: getProductImageUrl(item) }} style={styles.itemImage} contentFit="cover" />
        <View style={styles.itemInfo}>
          ...
          <TouchableOpacity onPress={() => handleRemove(item)} disabled={isUpdating} activeOpacity={0.7}>
    ...
    <View style={styles.container}>
      ...
      {isLoading ? (
        ...
        <View style={styles.stateContainer}>
          ...
          <Text style={styles.emptyText}>Products added from event pages will appear here.</Text>
        </View>
      ) : (
      ...
      <View style={[styles.summaryContainer, { marginBottom: insets.bottom + 80 }]}>
        <View style={styles.summaryCard}>
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.summaryValue}>{formatMoney(cart.subtotalUsd)}</Text>
          </View>
          <View style={styles.summaryRow}>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.summaryValue}>{formatMoney(roundCurrency(cart.subtotalUsd * PLATFORM_FEE_RATE))}</Text>
          </View>
          <View style={styles.summaryRow}>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.totalValue}>{formatMoney(roundCurrency(cart.subtotalUsd * (1 + PLATFORM_FEE_RATE)))}</Text>
          </View>
        </View>
      </View>
