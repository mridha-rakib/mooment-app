...
const TicketDetailScreen = () => {
  ...
  const params = useLocalSearchParams<{
    ...
    remainingPurchasableQuantity?: string;
  }>();
  ...
  const details = [
    ...
    { label: "Age restriction", value: formatEventAgeRestriction(event?.ageRestriction) },
  ...
  const remainingPurchasableQuantity = parsePositiveInteger(params.remainingPurchasableQuantity, 0);
  ...
  const walletDetails = [
    ...
    ...(remainingPurchasableQuantity > 0
      ? [{
          label: "More tickets",
          value: `${remainingPurchasableQuantity} more ${remainingPurchasableQuantity === 1 ? "ticket" : "tickets"} of this type available`,
        }]
      : []),
